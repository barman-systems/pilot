const script=String.raw`(()=>{
  ...
  style.textContent=[
    ...
    '@media(max-width:780px){.dshGrid{grid-template-columns:1fr}.dshMetrics{grid-template-columns:repeat(2,1fr)}.dshTicketHead{flex-direction:column}.dshContacts{grid-template-columns:1fr}.dshReply{flex-direction:column}.dshMsg{max-width:96%}.dshFab{inset-inline-end:14px;bottom:14px}}',
    '@media(max-width:700px){.dshFab{bottom:calc(78px + env(safe-area-inset-bottom))}}'
  ].join('');
