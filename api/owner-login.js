...
<style>
:root{color-scheme:dark;--bg:#08090a;--panel:#111315;--line:#2a2f34;--text:#f7f8f9;--muted:#aeb5bd;--accent:#d7ff5f;--amber:#ffd87a;--green:#8ce6a1}*{box-sizing:border-box}html,body{margin:0;min-height:100%;background:radial-gradient(circle at 50% -15%,#20252b 0,#0c0e10 38%,var(--bg) 70%);color:var(--text);font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Tahoma,Arial,sans-serif;font-size:16px;line-height:1.55}button,input{font:inherit}button,input{min-height:48px}.wrap{min-height:100vh;min-height:100dvh;display:grid;place-items:center;padding:max(20px,env(safe-area-inset-top)) max(16px,env(safe-area-inset-right)) max(20px,env(safe-area-inset-bottom)) max(16px,env(safe-area-inset-left))}.card{width:min(440px,100%);border:1px solid var(--line);background:#111315ed;border-radius:24px;padding:24px;box-shadow:0 24px 80px #0009}.brand{display:flex;align-items:center;gap:12px}.logo{width:48px;height:48px;border-radius:14px;display:grid;place-items:center;background:linear-gradient(135deg,#2e246b,#245fd6 55%,#38c8d9);border:1px solid #617dff66;font-weight:950}.brand b{font-size:16px}.brand small,.muted{color:var(--muted);font-size:13px}h1{font-size:26px;line-height:1.25;margin:24px 0 8px}p{font-size:14px;line-height:1.75;color:var(--muted);margin:0 0 12px}.field{margin-top:16px}.field label{display:block;color:var(--muted);font-size:13px;font-weight:700;margin-bottom:7px}.field input{width:100%;border:1px solid var(--line);background:#181b1f;color:#fff;border-radius:13px;padding:12px 13px;font-size:16px}.field input[readonly]{color:#d7dde3;background:#131619}.otp input{text-align:center;direction:ltr;letter-spacing:.28em;font-size:22px;font-weight:900}.btn{width:100%;border:0;background:var(--accent);color:#10130b;border-radius:13px;padding:12px 14px;font-size:15px;font-weight:900;cursor:pointer;margin-top:18px}.btn:disabled{opacity:.55;cursor:wait}.ghost{min-height:44px;border:0;background:transparent;color:var(--muted);cursor:pointer;padding:9px;margin-top:6px;font-size:13px}.ghost:disabled{opacity:.5}.msg{min-height:36px;margin-top:11px;color:var(--amber);font-size:13px;line-height:1.65}.msg.ok{color:var(--green)}.foot{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-top:12px;border-top:1px solid #22272c;padding-top:12px}.lang{min-height:44px;border:1px solid var(--line);background:#171a1d;color:#fff;border-radius:10px;padding:8px 12px;cursor:pointer;font-size:13px}.hidden{display:none!important}button:focus-visible,input:focus-visible{outline:3px solid var(--accent);outline-offset:2px}@media(max-width:430px){.card{padding:20px 17px;border-radius:20px}h1{font-size:24px}.foot{align-items:flex-start}.muted{max-width:75%;line-height:1.6}}@media(prefers-reduced-motion:reduce){*,*::before,*::after{animation-duration:.001ms!important;animation-iteration-count:1!important;transition-duration:.001ms!important;scroll-behavior:auto!important}}
</style>
</head>
<body>
<div class="wrap">
