const script = String.raw`(()=>{
  ...
  style.textContent=[
    ...
    '.dcAsk{gap:8px!important}.dcInput{min-height:50px!important;border:1px solid var(--ds-border-strong)!important;background:#081525!important;color:var(--ds-text)!important;border-radius:11px!important;padding:11px 13px!important;font-size:14px!important;box-shadow:none!important}.dcInput:focus{border-color:#7185ff!important;box-shadow:0 0 0 3px #4961e820!important}.dcAsk button{min-width:88px!important;border:1px solid #ffffff12!important;border-radius:10px!important;background:linear-gradient(135deg,var(--ds-ai-violet),var(--ds-ai-blue) 62%,var(--ds-ai-cyan))!important;color:#fff!important;font-weight:760!important;box-shadow:none!important}',
    '.dcSuggestions{gap:6px!important;margin-top:9px!important}.dcSuggestion{min-height:36px!important;border:1px solid var(--ds-border)!important;background:#ffffff05!important;color:#bcc7d6!important;border-radius:999px!important;padding:7px 10px!important;font-size:11px!important;font-weight:650!important}.dcSuggestion:hover{border-color:#4961e855!important;color:#fff!important;background:#4961e812!important}',
    ...
    '}',
    '#authGate .field label,#onboardingGate .field label{font-size:14px!important}#authGate .authHint{font-size:13px!important}.authLegal{font-size:14px!important}.authLegal a,.lang button{min-height:44px!important}.modalBox{max-height:calc(100dvh - 36px - env(safe-area-inset-top) - env(safe-area-inset-bottom));overflow-y:auto;overscroll-behavior:contain}.modalActions{flex-wrap:wrap}.compose input{min-width:0}#authGate .authCard{margin-block:auto}',
