...
Historical scope: this report records the initial audit. See [the activity restructuring report](DABBIR_ACTIVITY_EXPERIENCE_2026-09-05.md) for later implementation and verification.
