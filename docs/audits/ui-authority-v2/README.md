...
كشف تشغيل WebKit على `5968fac7db6ceca0218238485f007041b49726d1` غياب الوقت المختار رغم صحة الموقع اليدوي (المقارنات البصرية 12/12 كانت ناجحة). وحدة `api/gcc-public-booking-ui.js` كانت تعيد كتابة نصوص الأوقات والأسعار دون فحص التغيير، ويعيد MutationObserver تشغيلها كل إطار. صارت الكتابات idempotent مع الحفاظ على عقد البلد/العملة/المنطقة الزمنية. اختبار المتصفح يتحقق من صفر تغييرات ذاتية على نص زر الوقت عبر الإطارات، وثبات العقدة، ثم نجاح الاختيار قبل إدخال الموقع. لا إعادة نقر لإخفاء الفشل ولا زيادة timeout.
