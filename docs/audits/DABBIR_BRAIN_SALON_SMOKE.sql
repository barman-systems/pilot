...
begin
 ...
 insert into public.dabbir_businesses(id,slug,name,business_type,demo_mode) values(biz,'qa-brain-'||biz,'Understanding V2 rollback QA','salon',true);
 ...
 insert into public.dabbir_services(id,business_id,name,name_ar,duration_minutes,price_aed,active) values(svc,biz,'QA salon','قص تجريبي',60,50,true);
 ...
 result:=public.dabbir_activity_service_configure_v1(biz,br,svc,0,'{"activity_type":"salon","delivery_modes":["AT_BUSINESS"]}');
 reset role;
