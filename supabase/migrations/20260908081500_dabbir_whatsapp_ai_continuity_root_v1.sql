-- DABBIR WhatsApp AI continuity root repair.
-- Provider/model outages are degraded system events, not customer human requests.
...
begin
  ...
  -- Crucially: no handoff and no conversation action_required transition here.
