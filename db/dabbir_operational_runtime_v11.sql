...
drop policy if exists dabbir_handoffs_insert on public.dabbir_handoffs;
create policy dabbir_handoffs_insert
on public.dabbir_handoffs
for insert
to authenticated
with check (dabbir_private.has_permission(business_id,'manage_handoffs'));
