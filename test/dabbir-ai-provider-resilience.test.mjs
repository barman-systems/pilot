...
test('last-resort Gateway gets a realistic bounded window instead of the old 2.5s cold-start cutoff',()=>{
...
test('public AI readiness exposes aggregate redundancy truth without provider credentials',()=>{
