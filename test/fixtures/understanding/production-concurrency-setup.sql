...
begin
 ...
 insert into public.dabbir_businesses(id,slug,name,business_type,demo_mode) values(biz,'qa-brain-'||biz,'DABBIR AI QA concurrency 20260910','car_wash',true);
 ...
 perform set_config('dabbir.concurrent_fixture',jsonb_build_object('business',biz,'owner',own,'conversation',conv,'batch',batch,'lock',lock,'past',past)::text,true);
end $smoke$;
select current_setting('dabbir.concurrent_fixture')::jsonb as fixture;
commit;
